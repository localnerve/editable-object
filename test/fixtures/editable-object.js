...
/**
  ...
  connectedCallback () {
    ...
    shadowRoot.innerHTML = '<style>:host {\
  --eo-min-width: 300px;\
  --eo-bg-color: #fafafa;\
  --eo-border-radius: 4px;\
  --eo-border-focused-color: #444;\
  --eo-border-defocused-color: #aaa;\
  --eo-item-selected-color: #f8f8f8;\
  --eo-item-hover-color: #eee;\
  --eo-item-input-border-color: #bbb;\
  --eo-icon-color: #444;\
}\
\
:host(.disabled) {\
...
.editable-object:not(.defocused) li.selected {\
  background: var(--eo-item-selected-color);\
}\
\
li, div > div {\
  display: flex;\
...
\
.editable-object:not(.defocused) li:hover {\
  background: var(--eo-item-hover-color);\
}\
\
.property-wrapper {\
  display: flex;\
...
\
.add-new-object-property-input, .edit-object-property-input {\
  padding: 6px 8px;\
  border-radius: 4px;\
  border: 1px solid var(--eo-item-input-border-color);\
  font-size: 14px;\
  font-family: inherit;\
}\
\
.editable-object.defocused .add-new-object-property-input {\
  border: 1px solid transparent;\
  opacity: 0.5;\
}\
\
.edit-object-property-input {\
  margin-left: -8px;\
}</style><div class="editable-object defocused">\
  <ul class="object-properties">\
  </ul>\
  <div class="new-object-property">\
    <input class="add-new-object-property-input" type="text" placeholder="Add new property in key:value format">\
    <div class="toolbar">\
      <button class="editable-object-add-property icon" title="Add">\
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24" height="24" viewBox="0 0 24 24">\
